...
try:
    ...
    try:
        ...
        from config import ML_MODEL_PATH, MAX_SEQUENCE_LENGTH, CONFIDENCE_THRESHOLD, USE_GPU
    except ImportError:
...
class RealMLClassifier:
    ...
    def __init__(
        ...
        # Model initialization mit Retry-Mechanismus
    ...
    def classify_text(self, text: str) -> Union[Dict[str, Any], ClassificationResult]:
        ...
        # Rückgabe als Pydantic-Modell falls verfügbar
        if PYDANTIC_AVAILABLE:
    ...
    def classify_pdf(
        ...
        try:
            # PDF-Text mit Chunking extrahieren
            ...
            logger.info("PDF extrahiert für Klassifikation", 
    ...
    def classify_multiple_pdfs(self, pdf_directory: Union[str, Path]) -> List[Dict]:
        ...
        try:
            ...
            extracted_contents = self.pdf_extractor.extract_multiple_pdfs(pdf_directory)
...
def demo_enhanced_classifier() -> None:
    ...
    try:
        ...
        if hasattr(result, 'dict'):
            result_data = result.dict()
            print(f"   Kategorie: {result_data['category']}")
        ...
        if hasattr(batch_result, 'dict'):
            ...
            for i, result in enumerate(batch_data['results'][:3]):
                if hasattr(result, 'dict') if PYDANTIC_AVAILABLE else isinstance(result, dict):
                    ...
                    print(f"     {i+1}. Kategorie: {res_data['category']}, Confidence: {res_data['confidence']:.3f}")
        ...
        if test_pdf.exists():
            try:
                ...
                if hasattr(pdf_result, 'dict'):
                    ...
                    print(f"   Kategorie: {pdf_result['category']}")
        ...
        print("\n🎉 Enhanced Demo abgeschlossen! Batch, Retry & Schema getestet.")
