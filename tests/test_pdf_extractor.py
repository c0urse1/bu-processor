...
class TestEnhancedPDFExtractor:
    ...
    def sample_pdf_path(self):
        """Pfad zu Test-PDF (kann existieren oder nicht)."""
    ...
    def test_extract_with_pymupdf_success(self, extractor, mocker, mock_fitz_document, sample_pdf_path):
        ...
        mocker.patch.object(sample_pdf_path, "exists", return_value=True)
        mocker.patch.object(sample_pdf_path, "stat", return_value=mocker.Mock(st_size=1024*1024))
...
class TestErrorHandlingAndExceptions:
    ...
    def test_pdf_corrupted_error(self, mocker, sample_pdf_path):
        ...
        mocker.patch.object(sample_pdf_path, "exists", return_value=True)
        mocker.patch.object(sample_pdf_path, "stat", return_value=mocker.Mock(st_size=1024))
