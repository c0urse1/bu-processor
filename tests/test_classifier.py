...
class TestRealMLClassifier:
    ...
    def mock_model_components(self, mocker):
        ...
        mock_tokenizer.return_value.to = mocker.Mock(return_value=mock_tokenizer.return_value)
...
class TestMockedTransformerCalls:
    ...
    def test_classify_returns_probabilities(self, mocker):
        ...
        fake_tokenizer.return_value.to = mocker.Mock(return_value=fake_tokenizer.return_value)
...
class TestIntegrationScenarios:
    ...
    def test_end_to_end_text_classification(self, mocker):
        ...
        mock_tokenizer = mocker.Mock()
        mock_tokenizer.return_value = {
            'input_ids': torch.tensor([[101, 2045, 2003, 102]]),  # BERT-like token IDs
